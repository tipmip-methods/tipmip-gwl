...
shared 0.02 °C grid (0–4 °C). Default model: MIROC-ES2L (dn-from-4 °C).

Usage::

    python paper/plot_hysteresis_mlotst_spg.py \\
...
DEFAULT_OUT = PAPER_DIR / "figures" / "hysteresis_mlotst_spg_4c.png"
